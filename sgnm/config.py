...
class DataConfig:
    ...
    reactivity_paths: list[str] | str = ""
    """Path(s) to HDF5 reactivity datasets, one per condition.
    Each entry is ``path/to/file.h5`` or ``path/to/file.h5:key``."""
...
class ScoringConfig:
    ...
    """Which output channels to use for scoring (None = all)."""
